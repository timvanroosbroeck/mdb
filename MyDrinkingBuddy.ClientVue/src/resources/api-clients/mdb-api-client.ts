  ...
  protected processGetAll(response: AxiosResponse): Promise<DrinkDto[]> {
    ...
    if (status === 200) {
      ...
      if (Array.isArray(resultData200)) {
        result200 = [] as any;
        for (let item of resultData200) result200!.push(DrinkDto.fromJS(item));
      } else {
        result200 = <any>null;
      }
...
export class SessionClient extends ClientBase {
  ...
  get(
    ...
    if (sessionId === undefined || sessionId === null)
      throw new Error(
        "The parameter 'sessionId' must be defined and cannot be null."
      );
    else url_ += "sessionId=" + encodeURIComponent("" + sessionId) + "&";
    url_ = url_.replace(/[?&]$/, "");
  ...
  saveDrink(
    sessionDrinkDto: SessionDrinkDto,
    cancelToken?: CancelToken | undefined
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.createdOn = _data["createdOn"]
        ? dayjs(_data["createdOn"].toString())
        : <any>undefined;
      this.createdBy = _data["createdBy"];
      this.modifiedOn = _data["modifiedOn"]
        ? dayjs(_data["modifiedOn"].toString())
        : <any>undefined;
